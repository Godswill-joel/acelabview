...
export default function ExpectSection() {
  return (
    <section className="w-full min-h-screen bg-white flex items-center justify-center px-6 md:px-12 lg:px-20 overflow-hidden">
    <div className="max-w-7xl w-full flex flex-col md:flex-row items-start md:items-center gap-12">
      {/* LEFT SIDE - Text Content */}
      <div className="w-full md:w-1/2">
        {/* Section Header */}
        <p className="text-[#2661E9] font-semibold mb-4 text-3xl sm:text-4xl">
        ...
        <Button
          className="bg-[#2661E9] hover:bg-[#1a4bb8] text-white font-bold transition-colors mt-8"
          size="md"
        >
          Learn More
        </Button>
